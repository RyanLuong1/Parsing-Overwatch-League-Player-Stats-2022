...
kickoff_clash_global_maps_count.to_csv("kickoff_clash/kickoff_clash_global_maps_count.csv")
kickoff_clash_teams_maps_count.to_csv("kickoff_clash/kickoff_clash_teams_maps_count.csv")

midseason_madness_global_maps_count.to_csv("midseason_madness/midseason_madness_global_maps_count.csv")
midseason_madness_teams_maps_count.to_csv("midseason_madness/midseason_madness_teams_maps_count.csv")

summer_showdown_global_maps_count.to_csv("summer_showdown/summer_showdown_global_maps_count.csv")
summer_showdown_teams_maps_count.to_csv("summer_showdown/summer_showdown_teams_maps_count.csv")

countdown_cup_global_maps_count.to_csv("countdown_cup/countdown_cup_global_maps_count.csv")
countdown_cup_teams_maps_count.to_csv("countdown_cup/countdown_cup_teams_maps_count.csv")

grand_finals_global_maps_count.to_csv("grand_finals/grand_finals_global_maps_count.csv")
grand_finals_teams_maps_count.to_csv("grand_finals/grand_finals_teams_maps_count.csv")